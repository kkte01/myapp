<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- Branding Image -->
            <a class="navbar-brand" href="{{ auth()->check() ? route('home') : route('/') }}">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                &nbsp;<li {!! Illuminate\Support\Str::contains(request()->path(), 'docs') ? 'class="active"' : '' !!}>
                    <a href="{{ url('docs') }}">
                        {{ trans('docs.title') }}
                    </a>
                </li>
                &nbsp;<li {!! Illuminate\Support\Str::contains(request()->path(), ['tags', 'articles']) ? 'class="active"' : '' !!}>
